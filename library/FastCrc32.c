 ...
 *
 * The fast version aims at using a few cycles as possible.
 *
 * Note that the fast version does not the additional zeroes or the
 * initial processing of the initial value that the SmallCrc version
 * require.
 *
 * Example of usage:
 *
...
/*
   ...
   call to FastCrc32. The result of this function must be used as the
